...
public final class NavCatItemBinding implements ViewBinding {
  ...
  private NavCatItemBinding(@NonNull CardView rootView, @NonNull TextView viewAllDes,
  ...
  public static NavCatItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new NavCatItemBinding((CardView) rootView, viewAllDes, viewAllImg, viewAllName,
